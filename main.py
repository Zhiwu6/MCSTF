...
def main(config):
    ...
    # save_images_pkl(dataset_name,images,subjectsVideos,subjects)
    # images, subjects, subjectsVideos = load_images_pkl(dataset_name)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_dir', type=str, default="D:\\Code1\\SoftNetTest\\softnetest\\CASME_sq")
