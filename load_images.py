...
def load_images(dataset_name):
    ...
    if (dataset_name == 'CASME_sq'):
        for i, dir_sub in enumerate(natsort.natsorted(glob.glob(dataset_name + "\\rawpic_crop1\\*"))):
            ...
            for dir_sub_vid in natsort.natsorted(glob.glob(dir_sub + "\\*")):
                ...
                # .split('_')[1][
                #                         :4]
                # subjectsVideos[-1].append(dir_sub_vid.split('\\')[-1])  # Ex:'CASME_sq/rawpic_aligned/s15/0101' -> '0101'
